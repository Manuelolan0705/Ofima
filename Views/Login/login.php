  ...
  <body>
    ...
    <div class="login-box">
      ...
      <form class="login-form" name="formLogin" id="formLogin" action="">
           <h3 class="login-head"><i class="fa fa-user-o" aria-hidden="true"></i>INICIAR SESIÓN</h3>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          <h3 class="login-head"><i class="fa fa-commenting-o" aria-hidden="true"></i>¿Olvidaste contraseña?</h3>
          <div class="form-group">
