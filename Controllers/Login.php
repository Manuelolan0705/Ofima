...
{
  $data['page_tag'] = "Login - Ofima";
  $data['page_title'] = "Ofima";
      ...
      if($_POST){
        if(empty($_POST['txtEmail']) || empty($_POST['txtPassword'])){
          ...
          if(empty($requestUser)){
            ...
            $arrDatav = $this->model->selectValesPe($_SESSION['idUser']);
            $_SESSION['userDatav']=  $arrDatav;
        ...
        if(empty($_POST['txtEmailReset'])){
          ...
          if(empty($arrData)){
            ...
            $idpersona = $arrData['idpersona'];
             $nombreUsuario = $arrData['nombres'].' '.$arrData['appat'].' '.$arrData['apmat'];
